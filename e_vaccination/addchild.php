...
<input type="number" name="cage" class="text" placeholder="enter youe Age" />
<input type="number" name="cweight" class="text" placeholder="enter your Weight" />
<input type="number" name="cheight" class="text" placeholder ="enter your Height" />
</br></br>
...
<?php
	...
	if(isset($_POST['addchild']))
	{
		...
		echo "<script>alert('Child Details added sucessfully');window.location='parentindex.php'</script>";
	}
?>
